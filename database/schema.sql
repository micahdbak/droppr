...
-- This will return at most 1 row always because of the below index.
...
CREATE TABLE files (
    label   UUID NOT NULL PRIMARY KEY,
    drop_id UUID NOT NULL REFERENCES drops(id),
    name    varchar(255) NOT NULL,
    size    bigint NOT NULL,
    type    varchar(100) NOT NULL
);
-- To get fileinfo given a drop ID:
--   SELECT label, name, size, type FROM files WHERE drop_id = $1;
